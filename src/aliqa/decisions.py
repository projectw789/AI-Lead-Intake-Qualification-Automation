...
def decision_one(first_ai_response, first_query):
    if isinstance(first_ai_response, FirstClientQuery):
        ...
        if second_ai_response == False:
            return ("sorry, the service that you require and your contact email is a minimum for us to accept a query. we also request that you state your desired completion timeframe as a whole number of weeks, e.g. 3 weeks. please restart the applicaton and try again")
